...
export function ErrorState({ message, action }: { message: string; action?: ReactNode }) { return <div className="ui-error" role="alert"><AlertCircle aria-hidden="true" /><div><strong>Une erreur est survenue</strong><p>{message}</p>{action}</div></div>; }
